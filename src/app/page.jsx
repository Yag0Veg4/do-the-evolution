  ...
  return (
    <div>
        ...
        <div className='bg-zinc-900 text-white text-center p-3 lg:p-16'>
          ...
          <div className="mx-1 lg:mx-24 lg:border border-lime-500">
            <div className='lg:px-16 py-10 border-lime-500 border'>
            ...
            <div className='text-left grid grid-cols-1 lg:grid-cols-3 border lg:border-none border-lime-500'>
              {epochs.map((epoch, i) => (
